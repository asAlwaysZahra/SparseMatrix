...
به نام پروردگار هدایت کننده به راه راست
  ...
  پروژه دوم - نسخه الگوریتمی - فشرده‌سازی ماتریس خلوت 
...
منظور از ماتریس خلوت، ماتریسی است که تعداد خانه‌های صفر آن بسیار زیاد بوده و نسبت خانه‌های غیرصفر به صفر در آن عدد کوچکی خواهد شد. به عنوان مثال در شکل زیر می‌توانید یک ماتریس خلوت را مشاهده کنید:
  ...
  <img src="https://s24.picofile.com/file/8454267450/matrix1p2ii.PNG"  width="300"/>
...
برای نمونه نمایش انتزاعی ذخیره‌سازی در حالتی که اندبس‌ها رو ستون‌ها تعریف شده باشند، به شکل زیر خواهد بود:

  <img src="https://s25.picofile.com/file/8454272168/Picture4.png"  width="500"/>
...
<div dir='ltr' align="justify">
  ...
  ## بخش امتیازی
ذخیره سازی را بصورتی انجام دهید که همزمان آرایه سطر و ستون از اندیس‌ها را داشته باشیم و زنجیره اتصال نودهای لینک لیست بصورت دوبعدی به شکلی که هم بصورت سطری و هم ستونی باشند.  نمایش انتزاعی ذخیره‌سازی آن به شکل زیر خواهد بود:

   <img src="https://s25.picofile.com/file/8454272176/Picture5.png"  width="300"/>
...
+ با پیاده‌سازی قسمت امتیازی سه توکن اضافه دریافت خواهید کرد.
